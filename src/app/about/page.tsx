      ...
      <main className="flex-grow relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            ...
            <div className="text-center mb-20">
                ...
                >
                    About <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-slate-600">{APP_CONSTANTS.APP_NAME}</span>
                </h1>
            ...
            {/* Mission & Values */}
            <div className="bg-white/60 backdrop-blur-md rounded-3xl p-10 md:p-16 shadow-xl mb-24 border border-teal-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    <div className="p-6 rounded-xl hover:bg-white hover:shadow-lg transition-all duration-300">
                        <div className="w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-6 text-teal-500 text-2xl">
                            ✨
                        </div>
                    ...
                    <div className="p-6 rounded-xl hover:bg-white hover:shadow-lg transition-all duration-300">
                        <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6 text-amber-500 text-2xl">
                            🎨
                        </div>
                    ...
                    <div className="p-6 rounded-xl hover:bg-white hover:shadow-lg transition-all duration-300">
                        <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-6 text-slate-500 text-2xl">
                            💖
                        </div>
            ...
            <div className="text-center relative">
                 <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] h-[120%] bg-gradient-to-r from-teal-50 to-amber-50 -z-10 rounded-[3rem] opacity-50 blur-3xl" />
                <h2 
                    className="text-3xl md:text-4xl font-bold mb-6 text-gray-800"
                    style={{ fontFamily: theme.typography.fontFamily.serif.join(', ') }}
                >
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <a 
                        href="/products" 
                        className="px-8 py-3 bg-teal-500 text-white rounded-full font-medium shadow-lg hover:bg-teal-600 hover:shadow-teal-300/50 transition-all transform hover:-translate-y-1"
                    >
                        View Collection
                    </a>
                    <a 
                        href="/contact" 
                        className="px-8 py-3 bg-white text-teal-600 border-2 border-teal-200 rounded-full font-medium hover:bg-teal-50 transition-all transform hover:-translate-y-1"
                    >
                        Get in Touch
                    </a>
                </div>
